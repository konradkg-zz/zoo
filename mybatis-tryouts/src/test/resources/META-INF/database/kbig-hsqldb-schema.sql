   ...
   create table identification_numbers (
      ...
      idn_date_inserted    datetime             DEFAULT CURRENT_TIMESTAMP not null ,
      idn_date_modified    datetime             DEFAULT CURRENT_TIMESTAMP not null ,
   ...
   create table roles (
      rol_id               smallint             GENERATED BY DEFAULT AS IDENTITY(START WITH 0) not null,
